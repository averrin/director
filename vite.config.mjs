...
// ATTENTION!
// You must change `base` and the `proxy` strings replacing `/modules/director/` with your
// module or system ID.
...
export default () => {
  ...
  return {
    ...
    base: '/modules/director/',    // Base module path that 30001 / served dev directory.
    ...
    server: {
      ...
      open: false,
      proxy: {
        '^(/modules/director/lang)': 'http://localhost:30000',
        '^(?!/modules/director/)': 'http://localhost:30000',
